...
namespace NzbDrone.Core.Applications.LazyLibrarian
{
    public class LazyLibrarian : ApplicationBase<LazyLibrarianSettings>
    {
        ...
        public LazyLibrarian(ILazyLibrarianV3Proxy lidarrV1Proxy, IConfigFileProvider configFileProvider, IAppIndexerMapService appIndexerMapService, Logger logger)
            : base(appIndexerMapService, logger)
        {
            _lazylibrarianV3Proxy = lidarrV1Proxy;
        ...
        public override void AddIndexer(IndexerDefinition indexer)
        {
            ...
            {
                var lidarrIndexer = BuildLazyLibrarianIndexer(indexer, indexer.Protocol);

                var remoteIndexer = _lazylibrarianV3Proxy.AddIndexer(lidarrIndexer, Settings);
        ...
        private LazyLibrarianIndexer BuildLazyLibrarianIndexer(IndexerDefinition indexer, DownloadProtocol protocol, string originalName = null)
        {
            ...
            var lidarrIndexer = new LazyLibrarianIndexer
            {
