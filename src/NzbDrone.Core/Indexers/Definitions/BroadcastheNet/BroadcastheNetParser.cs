...
namespace NzbDrone.Core.Indexers.BroadcastheNet
{
    public class BroadcastheNetParser : IParseIndexerResponse
    {
        ...
        public IList<ReleaseInfo> ParseResponse(IndexerResponse indexerResponse)
        {
            ...
            switch (indexerhttpresp.StatusCode)
            {
                ...
                default:
                    ...
                    {
                        throw new IndexerException(indexerResponse, "Indexer API call returned an unexpected StatusCode [{0}]", indexerhttpresp.StatusCode);
                    }

                    break;
            }

            if (indexerhttpresp.Headers.ContentType != null && indexerhttpresp.Headers.ContentType.Contains("text/html"))
            {
            ...
            JsonRpcResponse<BroadcastheNetTorrents> jsonResponse = new HttpResponse<JsonRpcResponse<BroadcastheNetTorrents>>(indexerhttpresp).Resource;
