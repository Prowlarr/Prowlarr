...
public class GazelleUserPassOrCookieSettings : GazelleSettings
{
    ...
    [FieldDefinition(4, Label = "Cookie", HelpText = "Use the Cookie field only if 2FA is enabled for your account, leave it empty otherwise.", Privacy = PrivacyLevel.Password, Type = FieldType.Password)]
