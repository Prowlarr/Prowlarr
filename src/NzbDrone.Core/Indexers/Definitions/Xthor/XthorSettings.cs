...
namespace NzbDrone.Core.Indexers.Definitions.Xthor
{
    public class XthorSettings : IIndexerSettings
    {
        ...
        [FieldDefinition(3,
            ...
            HelpText =
                "If you want to discover only freeleech torrents to not impact your ratio, check the related box.")]
        ...
        [FieldDefinition(5,
            Label = "Do you want to use enhanced FRENCH search?",
            Type = FieldType.Checkbox,
            HelpText = "If you search for VFF or VFQ accent, it will also search with VFF+VFQ accent.")]
        ...
        [FieldDefinition(9,
            ...
            Type = FieldType.Checkbox,
            HelpText =
                "if you have \"Anime\", this will improve queries made to this tracker related to this type when making searches. (This will change the episode number to EXXX)")]
        ...
        [FieldDefinition(10,
            ...
            Type = FieldType.Checkbox,
            HelpText =
                "(recommended) this indexer is compatible with TMDB queries (for movies only), so when requesting content with an TMDB ID, we will search directly ID on API. Results will be more accurate, so you can enable a max pages bypass for this query type.",
            Advanced = true)]
        ...
        [FieldDefinition(11,
            ...
            HelpText =
                "(not recommended) you can increase max pages to follow when making a request. But be aware that this API is very buggy on tracker side, most of time, results of next pages are same as the first page. Even if we deduplicate rows, you will loose performance for the same results.",
            Advanced = true)]
